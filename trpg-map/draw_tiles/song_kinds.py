...
KINDS = {
    ...
    "校场":   dict(group="军武", icon="arena",   zone="edge",    note="军队操练、点兵、校阅之所"),
    "武馆":   dict(group="军武", icon="martial", zone="core",  note="拳脚器械教习之所"),
    "军营":   dict(group="军武", icon="arena",   zone="edge",    note="驻军营寨、营房与辕门"),
    ...
    "交引铺": dict(group="金融", icon="money",   zone="core",  note="买卖交引、会子及盐茶等商券凭证"),
    "牙行":   dict(group="商市", icon="market",  zone="core",  note="撮合买卖、评估货物、介绍雇佣的中介行"),
    ...
    "菜市":   dict(group="商市", icon="food",    zone="core",  note="蔬果禽肉等日常食品市场"),
    "榷场":   dict(group="商市", icon="market",  zone="edge",  note="边境或指定地点的官设互市市场"),
    "粮行":   dict(group="商市", icon="grain",   zone="general", note="米粮买卖行"),
    "鱼行":   dict(group="商市", icon="food",    zone="water",  note="水产市"),
    "盐场":   dict(group="商市", icon="grain",   zone="water",  note="制盐、晒盐、储运与交易区域"),
    ...
    "纸坊":   dict(group="百工", icon="library", zone="water",  note="浸料、舂捣、抄纸、晾纸的造纸作坊"),
    "墨坊":   dict(group="百工", icon="library", zone="general", note="炼烟、和胶、制墨与晾墨作坊"),
    "笔坊":   dict(group="百工", icon="library", zone="general", note="选毫、束毫、装管的制笔作坊"),
    ...
    "糖坊":   dict(group="百工", icon="mill",    zone="general", note="榨蔗、熬糖、制糖的作坊"),
    "酱园":   dict(group="百工", icon="food",    zone="general", note="酱醋作坊"),
    "酒坊":   dict(group="饮食", icon="wine",    zone="general", note="酿酒发售"),
    "窑场":   dict(group="百工", icon="smith",   zone="edge",    note="烧造陶瓷、砖瓦的窑炉作业区"),
    "矿冶":   dict(group="百工", icon="smith",   zone="edge",    note="采矿、选矿、冶炼金属的生产区域"),
    "造船场": dict(group="百工", icon="boat",    zone="water",   note="船台、木料场与船只建造维修之所"),
    ...
    "消防铺": dict(group="城防", icon="fire",   zone="general", note="城市防火值守，存放水具、梯索与扑火器械"),
    "更房":   dict(group="城防", icon="fire",   zone="general", note="夜巡打更"),
    "市舶司": dict(group="官署", icon="office", zone="water",   note="管理海舶、抽解、贸易与外商事务的官署"),

    # ---------- 教育 / 医卜 ----------
    "书院":   dict(group="文教", icon="academy", zone="general", note="聚徒讲学"),
    "贡院":   dict(group="文教", icon="academy", zone="core", note="科举考试院，设号舍、考棚与锁院"),
    ...
    "安济坊": dict(group="医药", icon="med",     zone="general", note="官办或慈善性质的收治、赈济病患机构"),
    ...
    "道院":   dict(group="信仰", icon="temple", zone="general", note="道众修习、讲经、斋醮与居住的院落"),
    "文庙":   dict(group="信仰", icon="academy", zone="core", note="祭祀孔子并与地方官学相连的礼制建筑"),
    ...
    "广场":   dict(group="地标", icon="sight",   zone="core", note="城市公共集会、庆典、告示与交通汇聚空间"),
